...
from .views import registration_view, login_view, verify_login_view, profile_view, profile_edit_view, user_profile_view, logout_view, resend_sms_view,moderator_login_view
